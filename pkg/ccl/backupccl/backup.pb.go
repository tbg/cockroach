...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{0}
}
...
func (EncryptionInfo_Scheme) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{3, 0}
}
...
func (ScheduledBackupExecutionArgs_BackupType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{5, 0}
}
...
func (*BackupManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1}
}
...
func (*BackupManifest_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1, 0}
}
...
func (*BackupManifest_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1, 1}
}
...
func (*BackupManifest_Tenant) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1, 2}
}
...
type BackupManifest_TenantRevision struct {
	Time hlc.Timestamp          `protobuf:"bytes,1,opt,name=time,proto3" json:"time"`
	Desc *BackupManifest_Tenant `protobuf:"bytes,3,opt,name=desc,proto3" json:"desc,omitempty"`
}

func (m *BackupManifest_TenantRevision) Reset()         { *m = BackupManifest_TenantRevision{} }
func (m *BackupManifest_TenantRevision) String() string { return proto.CompactTextString(m) }
func (*BackupManifest_TenantRevision) ProtoMessage()    {}
func (*BackupManifest_TenantRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1, 3}
}
func (m *BackupManifest_TenantRevision) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BackupManifest_TenantRevision) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *BackupManifest_TenantRevision) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupManifest_TenantRevision.Merge(dst, src)
}
func (m *BackupManifest_TenantRevision) XXX_Size() int {
	return m.Size()
}
func (m *BackupManifest_TenantRevision) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupManifest_TenantRevision.DiscardUnknown(m)
}

var xxx_messageInfo_BackupManifest_TenantRevision proto.InternalMessageInfo
...
func (*BackupManifest_Progress) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{1, 4}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{2}
}
...
func (*EncryptionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{3}
}
...
func (*StatsTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{4}
}
...
func (*ScheduledBackupExecutionArgs) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{5}
}
...
func (*RestoreProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f5d8ce3b041c50c9, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*BackupManifest_TenantRevision)(nil), "cockroach.ccl.backupccl.BackupManifest.TenantRevision")
	...
	proto.RegisterMapType((map[string][]byte)(nil), "cockroach.ccl.backupccl.EncryptionInfo.EncryptedDataKeyByKMSMasterKeyIDEntry")
...
func (m *BackupManifest_TenantRevision) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BackupManifest_TenantRevision) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *BackupManifest_Progress) MarshalTo(dAtA []byte) (int, error) {
	...
	n19, err := m.RevStartTime.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n19
...
func (m *BackupPartitionDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	n20, err := m.BackupID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
...
func (m *EncryptionInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EncryptedDataKeyByKMSMasterKeyID) > 0 {
		...
		for _, k := range keysForEncryptedDataKeyByKMSMasterKeyID {
			...
			byteSize := 0
			if len(v) > 0 {
				byteSize = 1 + len(v) + sovBackup(uint64(len(v)))
			}
			mapSize := 1 + len(k) + sovBackup(uint64(len(k))) + byteSize
			i = encodeVarintBackup(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *RestoreProgress) MarshalTo(dAtA []byte) (int, error) {
	...
	n21, err := m.Summary.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n21
...
func (m *BackupManifest_TenantRevision) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EncryptionInfo) Size() (n int) {
	...
	if len(m.EncryptedDataKeyByKMSMasterKeyID) > 0 {
		for k, v := range m.EncryptedDataKeyByKMSMasterKeyID {
			...
			l = 0
			if len(v) > 0 {
				l = 1 + len(v) + sovBackup(uint64(len(v)))
			}
			mapEntrySize := 1 + len(k) + sovBackup(uint64(len(k))) + l
...
func (m *BackupManifest_TenantRevision) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TenantRevision: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TenantRevision: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_f5d8ce3b041c50c9) }

var fileDescriptor_backup_f5d8ce3b041c50c9 = []byte{
	...
	,
}
