...
type ReplicaState struct {
	...
	DescOutgoing *roachpb.RangeDescriptor `protobuf:"bytes,12,opt,name=desc_outgoing,json=descOutgoing,proto3" json:"desc_outgoing,omitempty"`
...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_19c5d105b0fadbbe, []int{0}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_19c5d105b0fadbbe, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_19c5d105b0fadbbe, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_19c5d105b0fadbbe, []int{2}
}
...
func (this *ReplicaState) Equal(that interface{}) bool {
	...
	if !this.DescOutgoing.Equal(that1.DescOutgoing) {
		return false
	}
...
func (m *ReplicaState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DescOutgoing != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintState(dAtA, i, uint64(m.DescOutgoing.Size()))
		n7, err := m.DescOutgoing.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *ReplicaState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DescOutgoing", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DescOutgoing == nil {
				m.DescOutgoing = &roachpb.RangeDescriptor{}
			}
			if err := m.DescOutgoing.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("storage/storagepb/state.proto", fileDescriptor_state_19c5d105b0fadbbe)
}

var fileDescriptor_state_19c5d105b0fadbbe = []byte{
	// 1054 bytes of a gzipped FileDescriptorProto
	,
}
