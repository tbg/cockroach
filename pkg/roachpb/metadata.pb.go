...
const (
	...
	// activities, including voting for leadership and committing entries.
	// Notably, voters are considered for quorum size of the raft group.
	ReplicaType_VOTER ReplicaType = 0
	// ReplicaType_LEARNER indicates a replica that applies committed entries, but
	// does not count towards the quorum. Learners do not vote for leadership nor
	// do their acknowledged log entries get taken into account for determining
	// the committed index. At the time of writing, learners in CockroachDB are a
	// short-term transient state: a replica being added and on its way to being a
	// VOTER.
	ReplicaType_LEARNER ReplicaType = 1
	// ReplicaType_VOTEROUTGOING TODO
	ReplicaType_VOTEROUTGOING ReplicaType = 2
)
...
func (ReplicaType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{0}
}
...
func (*ReplicationTarget) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{1}
}
...
func (*ReplicaDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{2}
}
...
func (*ReplicaIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{3}
}
...
func (*RangeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{4}
}
...
func (*Percentiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{5}
}
...
func (*StoreCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{6}
}
...
func (*NodeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{7}
}
...
func (*LocalityAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{8}
}
...
func (*StoreDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{9}
}
...
func (*StoreDeadReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{10}
}
...
func (*Locality) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{11}
}
...
func (*Tier) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{12}
}
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_b58d64c1bbf30135, []int{13}
}
...
func NewPopulatedReplicaDescriptor(r randyMetadata, easy bool) *ReplicaDescriptor {
	...
	if r.Intn(10) != 0 {
		v1 := ReplicaType([]int32{0, 1, 2}[r.Intn(3)])
		this.Type = &v1
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func init() { proto.RegisterFile("roachpb/metadata.proto", fileDescriptor_metadata_b58d64c1bbf30135) }

var fileDescriptor_metadata_b58d64c1bbf30135 = []byte{
	// 1371 bytes of a gzipped FileDescriptorProto
	,
}
